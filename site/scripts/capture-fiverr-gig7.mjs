...
const gigDir = join(__dirname, '../../fiverr/gig-07-bots');

const mockups = [
    { file: 'image-1-main.html', output: 'gig-image-1-main.png' },
    { file: 'image-2-features.html', output: 'gig-image-2-features.png' },
    { file: 'image-3-packages.html', output: 'gig-image-3-packages.png' }
];
