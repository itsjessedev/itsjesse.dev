...
const gigDir = join(__dirname, '../../fiverr/gig-06-automation');

const mockups = [
    { file: 'image-1-main.html', output: 'gig-image-1-main.png' },
    { file: 'image-2-examples.html', output: 'gig-image-2-examples.png' },
    { file: 'image-3-comparison.html', output: 'gig-image-3-comparison.png' }
];
