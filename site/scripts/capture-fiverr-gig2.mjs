...
const gigDir = join(__dirname, '../../fiverr/gig-02-api-integration');

const mockups = [
    { file: 'image-1-main.html', output: 'gig-image-1-main.png' },
    { file: 'image-2-apis.html', output: 'gig-image-2-apis.png' },
    { file: 'image-3-workflow.html', output: 'gig-image-3-workflow.png' }
];
