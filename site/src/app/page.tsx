        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="mb-8">
                <picture>
                  <source srcSet="/jesse-photo.webp" type="image/webp" />
                  <img
                    src="/jesse-photo.jpg"
                    alt="Jesse Eldridge"
              ...
              <div className="flex gap-4 mt-6">
                <a href="/resume.html" className="btn-primary">
                  View Resume
                </a>
                <a
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-[var(--text-secondary)] text-lg">
                Whether you&apos;re hiring for a full-time role or need help with a project, I&apos;d love to hear from you.
              </p>
            </div>
            <ContactForm />
